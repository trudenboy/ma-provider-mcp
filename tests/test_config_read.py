...
async def test_get_provider_masks_secret(mounted_config, mock_config_targets) -> None:  # noqa: ARG001
...
async def test_get_core_returns_values(mounted_config, mock_config_targets) -> None:  # noqa: ARG001
    result = await _call(mounted_config, "get_core", domain="webserver")
    assert any(v.key == "log_level" for v in result.data.values)


async def test_get_player_returns_values(mounted_config, mock_config_targets) -> None:  # noqa: ARG001
...
async def test_get_entries_lists_editable(mounted_config, mock_config_targets) -> None:  # noqa: ARG001
    result = await _call(
...
async def test_get_provider_unknown_raises(mounted_config, mock_mass) -> None:
...
async def test_get_dsp_returns_shape(mounted_config, mock_config_targets) -> None:  # noqa: ARG001
...
async def test_list_targets_rolls_up(mounted_config, mock_config_targets) -> None:  # noqa: ARG001
...
async def test_get_dsp_unknown_player_raises(mounted_config, mock_mass) -> None:
    from unittest.mock import AsyncMock
